#ifndef CAFFE_SIGMOID_MAX_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_MAX_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class SigmoidMaxCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidMaxCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidMaxCrossEntropyLoss"; }

 protected:
  /// @copydoc SigmoidMaxCrossEntropyLossLayer
...
#endif  // CAFFE_SIGMOID_MAX_CROSS_ENTROPY_LOSS_LAYER_HPP_
