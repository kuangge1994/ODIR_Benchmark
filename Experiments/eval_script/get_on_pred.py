...
path_test = 'the path of onsite testing set'        #e.g "OIA-ODIR/On-site Test Set/Images/"
text_left = './data_lst/left_ontest_label.txt'      #the path of left_text files in ./data_lst
text_right = './data_lst/right_ontest_label.txt'    #the path of right_text files in ./data_lst
